'Fancy Expensive for rich people who have forgotten all math since the 7th grade'
...
def area_triangle(base, height):
	...
	if base < 0.0 or height < 0.0:
		raise RuntimeError('Imaginary numbers not applicable to Kronecker spaces. Try resetting microcontroller L145')
